# TODO: Add zoom in/out with ctrl+'=' and ctrl+'-'
...
@export var follow_node : Node2D # Node to follow (assign this to player node)

var trauma : float = 0.0 # Current shake strength
var trauma_power : int = 2 # Increase for more extreme shaking
